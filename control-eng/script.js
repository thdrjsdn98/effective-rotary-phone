/* ============================================================
   ...
   반드시 STORAGE_PREFIX('electric_control_')로 시작합니다.
...
============================================================ */
var STORAGE_PREFIX = 'electric_control_';
...
var studyQuotes = [
    { text: "제어공학은 회로이론의 라플라스 변환·전달함수 개념 위에 세워진 과목이다. 헷갈리면 회로이론을 먼저 복습하자.", ref: "학습 팁" },
    { text: "블록선도는 그림으로 그려보면서 익히면 공식이 저절로 외워진다.", ref: "학습 습관" },
    { text: "s평면에서 극의 위치만 봐도 시스템이 안정한지 바로 알 수 있어야 한다.", ref: "핵심 포인트" },
...
function checkDailyNotify() {
    ...
    if (lastNotifyDate !== today) {
        ...
        new Notification('전기기사 제어공학 요약집 ⚡', {
...
async function exportUserData() {
    // 백업 데이터에는 이 프로젝트(electric_control_) 소유 데이터만 포함합니다.
    ...
    var filename = "전기기사_제어공학_백업_" + timestamp + ".json";
...
function importUserData(event) {
    ...
    reader.onload = function (e) {
        try {
            ...
            // 복원도 electric_control_ 네임스페이스 안에서만 수행 (다른 프로젝트 데이터 건드리지 않음)
...
// electric_control_ 로 시작하는 이 프로젝트 소유 키만 선별 삭제합니다.
...
/* ===================== 퀴즈 채점 ===================== */
var unitTitles = {
    1: "01. 자동제어계의 개요", 2: "02. 블록선도와 신호흐름선도", 3: "03. 시간영역 해석",
    4: "04. 주파수영역 해석", 5: "05. 제어계의 안정도", 6: "06. 근궤적",
    7: "07. 상태공간법", 8: "08. 시퀀스제어"
};
