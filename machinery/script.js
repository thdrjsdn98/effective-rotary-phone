/* ============================================================
   ...
   반드시 STORAGE_PREFIX('electric_machinery_')로 시작합니다.
...
============================================================ */
var STORAGE_PREFIX = 'electric_machinery_';
...
var studyQuotes = [
    { text: "전기기기는 직류기·동기기·변압기·유도기 사이의 공통 구조(전기자, 계자, 유도기전력)를 먼저 잡으면 훨씬 쉬워진다.", ref: "학습 팁" },
    ...
    { text: "변압기는 회로이론의 상호인덕턴스·등가회로 개념의 확장판이다.", ref: "학습 팁" },
...
function checkDailyNotify() {
    ...
    if (lastNotifyDate !== today) {
        ...
        new Notification('전기기사 전기기기 요약집 ⚡', {
...
async function exportUserData() {
    // 백업 데이터에는 이 프로젝트(electric_machinery_) 소유 데이터만 포함합니다.
    ...
    var filename = "전기기사_전기기기_백업_" + timestamp + ".json";
...
function importUserData(event) {
    ...
    reader.onload = function (e) {
        try {
            ...
            // 복원도 electric_machinery_ 네임스페이스 안에서만 수행 (다른 프로젝트 데이터 건드리지 않음)
...
// electric_machinery_ 로 시작하는 이 프로젝트 소유 키만 선별 삭제합니다.
