/* ============================================================
   ...
   반드시 STORAGE_PREFIX('electric_magnetism_')로 시작합니다.
...
============================================================ */
var STORAGE_PREFIX = 'electric_magnetism_';
...
var studyQuotes = [
    { text: "전자기학은 공식을 외우지 말고 유도과정을 따라가며 이해해야 오래 남는다.", ref: "학습 습관" },
    { text: "전기와 자기는 거의 모든 공식이 대응된다. Q↔m, ε↔μ, E↔H로 짝지어 외우자.", ref: "핵심 포인트" },
    { text: "벡터 연산(내적·외적·그래디언트)에 익숙해지면 나머지 단원이 훨씬 쉬워진다.", ref: "학습 팁" },
    { text: "필기는 5과목 중 40점 미만이 하나라도 있으면 과락이다. 약한 과목부터 채우자.", ref: "합격 기준 안내" },
    { text: "오늘 이해 안 된 유도과정은 내일 다시 보면 의외로 쉽게 풀린다.", ref: "학습 루틴" },
    { text: "가우스 법칙 하나만 제대로 이해하면 전하분포 문제 절반은 풀린다.", ref: "핵심 포인트" },
...
function checkDailyNotify() {
    ...
    if (lastNotifyDate !== today) {
        ...
        new Notification('전기기사 전기자기학 요약집 ⚡', {
...
async function exportUserData() {
    // 백업 데이터에는 이 프로젝트(electric_magnetism_) 소유 데이터만 포함합니다.
    ...
    var filename = "전기자기학_백업_" + timestamp + ".json";
...
function importUserData(event) {
    ...
    reader.onload = function (e) {
        try {
            ...
            // 복원도 electric_magnetism_ 네임스페이스 안에서만 수행 (다른 프로젝트 데이터 건드리지 않음)
...
// electric_magnetism_ 로 시작하는 이 프로젝트 소유 키만 선별 삭제합니다.
...
/* ===================== 퀴즈 채점 ===================== */
var unitTitles = {
    1: "01. 벡터", 2: "02. 정전계", 3: "03. 도체계와 정전용량",
    4: "04. 유전체와 특수현상", 5: "05. 전기회로", 6: "06. 정자계",
    7: "07. 자성체와 자기회로", 8: "08. 전자유도와 인덕턴스", 9: "09. 전자계"
};
